    ...
    <form method="POST" action="">
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="supplier_code" required value="<?php echo htmlspecialchars($supplier['supplier_code']); ?>">
            </div>
            
            <div class="form-group">
                <label>Supplier Name *</label>
                <input type="text" name="name" required value="<?php echo htmlspecialchars($supplier['name']); ?>">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="phone" required value="<?php echo htmlspecialchars($supplier['phone']); ?>">
            </div>
        </div>
